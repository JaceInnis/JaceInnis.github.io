...
Every day a slow rain of particles falls through the ocean. Produced in the sunlit surface layer — by phytoplankton blooms, by zooplankton grazing, and by the scavenging of mineral dust — this sinking material carries carbon, nutrients, and trace elements from the surface into the deep ocean. That transfer is the heart of the "biological pump," the set of processes that moves carbon out of contact with the atmosphere and into the ocean interior, where it can remain sequestered for centuries or longer.
